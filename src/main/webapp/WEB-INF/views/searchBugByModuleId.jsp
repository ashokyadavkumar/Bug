					...
					<div class="col-12 col-sm-12 col-md-12 col-lg-7 col-xl-7" style="border: 1px solid;background-color: #E0FFFF;margin-left: -16px;">
						<div class="login-content">
							<s:form class="create-account" action="searchByEmail" id="search"
								...
								<div class="row">
									<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" style="margin-top: 7%;margin-left: 17%;">
										<span style="font-size: 30px;font-weight: bold;color:#96358C">Search Bug By Module ID</span>
									</div>
									<div
										class="col-12  col-sm-4 col-md-4 col-lg-4 col-xl-4 margin-10-bottom">
										<label style="margin-left: 49%;margin-top: 7%;">Enter Module Id<sup>*</sup></label>
