							...
							<s:form class="create-account" action="searchById" id="search"
								...
								<div class="row">
									<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" style="margin-top: 23%;text-align:center">
										<span style="font-size: 30px;font-weight: bold;color:#96358C">Post BUG</span>
									</div>
									<div
										class="col-12  col-sm-4 col-md-4 col-lg-4 col-xl-4 margin-10-bottom">
										<label style="margin-left: 39%;margin-top: 7%;">Enter Module ID<sup>*</sup></label>
										<div class="form-group">
											<input style="margin-left: 129%; margin-top: -13%;"type="text" class="form-control" id="refUserRoleId" name="refUserRoleId"
