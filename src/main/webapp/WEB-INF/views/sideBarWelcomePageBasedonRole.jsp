...
<div class="two-form-div1" style="padding-left:149px;padding-top:31px;font:initial;background-color: #00F0F0;">
	<table>
		<tbody>
			...
			<tr>
				<td><a href="searchByDesignation" class="forgot-pass float-left" style="color:#4343BB;font-size:17px;text-decoration-line: underline;font-weight: bold ">View Bug By Date</a></td>
			</tr>
			<tr>
