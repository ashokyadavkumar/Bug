				...
				<div class="row">
					...
					<div class="col-12 col-sm-12 col-md-12 col-lg-7 col-xl-7" style="border: 1px solid;background-color: #FFC0CB;margin-left: -16px;">
						...
						<div style="margin-top:24%">
							<span style="margin-left:26%;color:#B5519A;font-weight:bold;font-size:26px;text-align:center">View BUG By Severity</span>
							
							<div><h2 style="text-align:center;font-size:20px;margin-top:10%;background-color:#800000">No Bug Found</h2></div>
