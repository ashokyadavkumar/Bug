   ...
   <div>
	...
	<div class="mandatory" style="color: red">${msg}</div>
		<div
			...
			<div>
		                        	<div>
		                            	<span style="margin-left:6%;font-weight: bold">Bug From</span>
		                            </div>
		                            <div class="col-12  col-sm-4 col-md-4 col-lg-4 col-xl-4 margin-10-bottom" style="margin-top:14px">
		                                <label style="margin-left:-69px">BUG Id<sup>*</sup></label>
		                                <div class="form-group" style="margin-top: -13%;margin-left: 40%;">
		                                    <input type="hidden" class="form-control"  id="id" name="id" value="${issueList.id}" maxlength="50" data-ignorepaste="" autocomplete="off">
		                            ...
		                            <div class="col-12  col-sm-4 col-md-4 col-lg-4 col-xl-4 margin-10-bottom" style="margin-top:14px">
		                                ...
		                                <div class="form-group" style="margin-top: -13%;margin-left: 40%;">
		                                    <input type="text" class="form-control"  id="issueName" name="issueName" value="${issueList.issueName}" maxlength="50" data-ignorepaste="" autocomplete="off">
		                                </div>
		                            </div>
		                            <div class="col-12  col-sm-4 col-md-4 col-lg-4 col-xl-4 margin-10-bottom">
		                                <label style="margin-left:-69px">Description</label>
		                                <div class="form-group" style="margin-top: -13%;margin-left: 40%;">
		                                <textarea rows="5" cols="152" name="description" id="description"  maxlength="2000">
		                                <c:out value="${issueList.description}" /></textarea>
						...
						<div class="form-group" style="margin-top: -13%;margin-left: 40%;">
						<textarea rows="5" cols="152" name="stepstoreProduce" id="stepstoreProduce"  maxlength="2000"><c:out value="${issueList.stepstoreProduce}" /></textarea>
