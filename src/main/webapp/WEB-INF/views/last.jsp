   ...
   <div>
	...
	<div class="mandatory" style="color: red">${msg}</div>
		<div
			...
			<div>
		                        	<div>
		                            	<span style="margin-left:6%;font-weight: bold">Post Task</span>
		                            </div>
		                            <div class="col-12  col-sm-4 col-md-4 col-lg-4 col-xl-4 margin-10-bottom" style="margin-top:14px">
		                                ...
		                                <div class="form-group" style="margin-top: -13%;margin-left: 40%;">
		                                    <input style="height:30px;width:115%; type="text" class="form-control"  id="firstName" name="firstName" value="${memRegList.firstName}" maxlength="50" data-ignorepaste="" autocomplete="off">
		                                </div>
		                            </div>
		                            <div class="col-12  col-sm-4 col-md-4 col-lg-4 col-xl-4 margin-10-bottom">
		                                <label style="margin-left:-69px">Bug Name</label>
		                                <div class="form-group" style="margin-top: -13%;margin-left: 40%;">
						...
						<label style="margin-left:-69px">Description<sup>*</sup></label>
						<div class="form-group" style="margin-top: -13%;margin-left: 40%;">
			...
			<div>
				...
				<div
					...
					<div class="form-group" style="margin-top: -13%;margin-left: 40%;">
						<input style="height:30px;width:115%; type="text" class="form-control" id="userName" name="userName" value="${memRegList.userName}" maxlength="20" data-ignorepaste="" autocomplete="off">
					</div>
				</div>
			...
			<div class="second-tab-btn float-right" style="margin-top:-68px">
